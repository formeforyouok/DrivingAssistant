//
//  ZHNavigationInteractiveTransition.m
//  DrivingAssistant
//
...
#import "ZHNavigationInteractiveTransition.h"
#import "ZHPopAnimation.h"
@interface ZHNavigationInteractiveTransition ()
@property (nonatomic, weak) UINavigationController *vc;
@property (nonatomic, strong) UIPercentDrivenInteractiveTransition *interactivePopTransition;
@end

@implementation ZHNavigationInteractiveTransition
...
- (id<UIViewControllerInteractiveTransitioning>)navigationController:(UINavigationController *)navigationController
     ...
     */
    if ([animationController isKindOfClass:[ZHPopAnimation class]])
